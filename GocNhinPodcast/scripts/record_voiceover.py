...
def main():
    ...
    parser.add_argument("episode", type=str,
                        help="Episode slug or directory (e.g. 'sieu-cong-trinh-va-bat-com' or 'episodes/sieu-cong-trinh-va-bat-com')")
    ...
    parser.add_argument("--speed", type=float, default=0.9,
                        help="Speaking speed tempo (default: 0.9 for documentary pacing)")
