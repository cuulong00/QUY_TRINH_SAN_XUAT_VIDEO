#!/usr/bin/env python3
"""
Google Cloud TTS Recorder for KenhTamLy
========================================
...
BASE_DIR = "/Users/pro16/Documents/VideoProject/KenhTamLy"
...
def clean_text_for_tts(text: str) -> str:
    ...
    text = text.replace("KenhTamLy", "Đạo và Khoa Học")
...
def main():
    parser = argparse.ArgumentParser(description="Google Cloud TTS Recorder for KenhTamLy")
    ...
    print(f"🎙️  Google Cloud TTS Recorder (Chirp 3 HD) — KenhTamLy")
