---
description: BƯỚC BẮT BUỘC để thu âm TTS voiceover cho tập phim podcast (từ chapter_XX.md) bằng hệ thống OmniVoice RunPod GPU chuẩn hóa.
---
...
> - Tại dự án `GocNhinPodcast`, thu âm được kích hoạt nhanh chóng thông qua script cầu nối:
>   ```bash
...
1. Xác định `slug` của tập phim (ví dụ: `sieu-cong-trinh-va-bat-com` hoặc `episodes/sieu-cong-trinh-va-bat-com`).
