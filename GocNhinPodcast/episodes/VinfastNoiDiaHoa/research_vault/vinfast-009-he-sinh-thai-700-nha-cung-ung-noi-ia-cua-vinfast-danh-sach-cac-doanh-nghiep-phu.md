---
title: "Hệ sinh thái 700 nhà cung ứng nội địa của VinFast: Danh sách các doanh nghiệp phụ trợ chính, sản phẩm cung cấp, và tác động đến nền kinh tế Việt Nam."
type: nblm-answer
asked_at: 2026-07-22T03:26:30.555Z
...
sources:
  ...
  - "VinES and Gotion High-Tech Break Ground at a 5GWh/Year LFP Battery Factory"
  - "Gotion building Vietnam's first LFP gigafactory - Energy-Storage.News"
  - "Ha Tinh's Industrial Sector Shines in the First Half of 2025 - Trung tâm DVTC & HTDN Tỉnh Hà Tĩnh"
  - "VINFAST REPORTS DELIVERIES OF 17955 ELECTRIC VEHICLES IN JUNE 2026 IN VIETNAM, REACHING A RECORD OF 115916 ELECTRIC VEHICLES IN THE FIRST HALF OF 2026"
  - "VinFast (NASDAQ: VFS) reports 115916 EV deliveries and 72% growth in H1 2026"
...
# Hệ sinh thái 700 nhà cung ứng nội địa của VinFast: Danh sách các doanh nghiệp phụ trợ chính, sản phẩm cung cấp, và tác động đến nền kinh tế Việt Nam.

> Asked on 2026-07-22T03:26:30.555Z against [NotebookLM notebook](https://notebooklm.google.com/notebook/0ee908ed-9f5d-4289-a143-a349af6c9fc1)

## Answer

Thoughts
Các nguồn tài liệu hiện tại không đề cập đến khái niệm hay danh sách "Hệ sinh thái 700 nhà cung ứng nội địa của VinFast".
Thay vào đó, các tài liệu làm rõ rằng mạng lưới nhà cung cấp của VinFast bao gồm 1.700 đối tác toàn cầu và khoảng 800 nhà cung cấp trực tiếp
1
. Do xuất phát điểm của Việt Nam có nền công nghiệp phụ trợ ô tô chưa phát triển (tỷ lệ nội địa hóa trung bình trước đây chỉ khoảng 20%)
2
, VinFast không lựa chọn mô hình thuê ngoài hoàn toàn mà áp dụng chiến lược tích hợp hệ thống toàn cầu kết hợp tự sản xuất nội địa
2
.
Dưới đây là chi tiết về danh sách đối tác, mô hình tự sản xuất và những tác động kinh tế của hệ sinh thái VinFast được ghi nhận từ các tài liệu:
I. Danh sách các đối tác công nghệ và nhà cung cấp chính
Để rút ngắn thời gian phát triển xe, VinFast đã áp dụng chiến lược "đứng trên vai người khổng lồ", hợp tác với các doanh nghiệp Tier-1 hàng đầu thế giới ở giai đoạn đầu trước khi chuyển giao công nghệ
3
:
Thiết kế và phát triển: Hợp tác với hai Studio danh tiếng của Ý là Pininfarina và Italdesign để tạo ngôn ngữ thiết kế
3
.
Tích hợp hệ thống và nền tảng: Thuê Magna Steyr tư vấn kỹ thuật tích hợp hệ thống
3
và mua bản quyền nền tảng từ BMW
3
.
Linh kiện cơ khí, điện tử và phần mềm: Ký hợp tác toàn diện với Bosch và ZF để cung cấp ECU, phần mềm và hệ thống phanh
3
.
Hệ sinh thái pin: Hợp tác cung ứng cell pin tiêu chuẩn với CATL, Gotion High-Tech và LG Chem
3
.
Giải pháp lái tự động (ADAS) và AI: Thành lập viện nghiên cứu ADAS tại Đức
3
, hợp tác với Tensor (Mỹ) chế tạo Robocar Level 4
4
5
, kết hợp với Autobrains (Israel) và NVIDIA phát triển hệ thống tự lái L4 cho Đông Nam Á
Các công ty liên kết trong hệ sinh thái Vingroup:
VinES Energy Solutions: Đảm nhiệm nghiên cứu, đóng gói bộ pin (Battery Pack)
9
và liên doanh sản xuất cell pin
10
11
.
Gotion High-Tech: Đối tác Trung Quốc nắm giữ 51% cổ phần (VinES nắm 49%) trong liên doanh sản xuất cell pin LFP tại Hà Tĩnh
10
12
.
VinRobotics: Hợp tác phát triển robot humanoid và hệ thống tự động hóa AI nhằm nâng cao năng suất và chất lượng tại các nhà máy của VinFast
13
14
. Hãng cũng dự kiến là đối tác sản xuất cho VinMotion và VinDynamics
13
14
.
VinAI & VinBigData: Phát triển trợ lý ảo tiếng Việt, hệ thống quan sát toàn cảnh và các thuật toán xử lý hình ảnh cho xe
3
.
(Lưu ý: Tài liệu cũng nhắc đến THACO Industries tại Chu Lai sở hữu tổ hợp 12 nhà máy cung ứng linh kiện khung vỏ, nhíp, ghế, kính, máy lạnh ô tô... cho nhiều hãng xe lớn
15
16
và cung cấp linh kiện OEM cho Hyundai, Toyota, Isuzu, Piaggio
17
, nhưng không nêu rõ THACO có nằm trong chuỗi cung ứng trực tiếp của VinFast hay không).
II. Mô hình tự sản xuất nội địa đạt tỷ lệ 60% – 64%
Để đạt tỷ lệ nội địa hóa vượt trội 60% - 64% vào cuối năm 2024 và hướng tới 80% - 84% vào năm 2026
9
17
, VinFast đã tự chủ sản xuất các cấu phần có khối lượng, kích thước và chi phí lớn nhất ngay tại Tổ hợp nhà máy Hải Phòng (335 ha)
3
9
:
Thân vỏ và Khung gầm: Được dập bằng công nghệ Schuler (Đức) và hàn tự động hóa 100% bằng 1.200 robot ABB
3
9
.
Động cơ điện (e-Motor): Tự thực hiện toàn bộ quá trình cơ khí hóa, quấn dây và lắp ráp tại xưởng động cơ riêng biệt trong tổ hợp
9
.
Đóng gói Pin: Các cell pin sau khi nhập khẩu hoặc sản xuất tại Hà Tĩnh sẽ được chuyển về xưởng pin Hải Phòng để đóng gói thành các bộ pin (Battery Pack) hoàn chỉnh
9
.
Nội - ngoại thất và cơ khí phụ trợ: Ghế ngồi, trần xe, bảng điều khiển, vành xe, hệ thống phanh, giảm xóc, các chi tiết nhựa và đèn xe đều được hoàn thiện trong nước
9
.
III. Tác động đến nền kinh tế Việt Nam
Sự hình thành chuỗi sản xuất và hệ sinh thái xe điện của VinFast mang lại những tác động sâu sắc đến cấu trúc kinh tế và định hướng công nghiệp của Việt Nam:
Bứt phá năng lực công nghiệp hỗ trợ quốc gia: Việc nâng tỷ lệ nội địa hóa từ mức 20% trung bình của ngành lên 60% - 64%
2
9
giúp Việt Nam chuyển dịch mạnh mẽ từ một nước thuần lắp ráp linh kiện nhập khẩu (CKD) sang tự chủ công nghệ chế tạo tinh học, cơ khí chính xác và điện tử công suất
2
9
.
Kiến tạo các tổ hợp công nghiệp quy mô lớn và giải quyết việc làm:
Nhà máy liên doanh pin LFP VinES-Gotion (Hà Tĩnh): Với tổng vốn đầu tư hơn 6.329 tỷ đồng (~275 triệu USD) trên diện tích 14 ha
, đây là nhà máy sản xuất cell pin LFP đầu tiên tại Việt Nam
. Nhà máy đi vào vận hành từ Quý 3/2024
23
24
đã tạo ra hơn 500 việc làm mới cho địa phương
22
24
và hoàn thiện chuỗi khép kín sản xuất pin tại chỗ
Nhà máy sản xuất xe điện VinFast Hà Tĩnh: Được khánh thành vào tháng 6/2025 với công suất 200.000 xe/năm
27
28
, tổ hợp này góp phần gia tăng nguồn thu ngân sách tỉnh và thúc đẩy hình thành chuỗi giá trị sản xuất - cung ứng - logistics xanh tại miền Trung
27
.
Cộng hưởng chính sách và thúc đẩy lộ trình chuyển đổi xanh: Sự bùng nổ doanh số của VinFast (đạt kỷ lục 115.916 xe điện trong nửa đầu năm 2026 tại Việt Nam)
29
30
đã cộng hưởng mạnh mẽ với các quyết sách của Chính phủ nhằm khuyến khích tiêu dùng xanh. Điển hình là việc kéo dài thời gian miễn 100% lệ phí trước bạ lần đầu đến hết năm 2030
31
32
và duy trì thuế tiêu thụ đặc biệt xe điện ở mức 3%
33
34
, giúp tối ưu hóa chi phí lăn bánh cho người dân, giảm ô nhiễm môi trường và thu hút thêm các dòng vốn FDI công nghệ cao vào Việt Nam
🔍 Tôi có thể làm cuộc nghiên cứu trên web để cập nhật danh sách các doanh nghiệp phụ trợ thuần Việt (Tier-2, Tier-3) đang cung ứng linh kiện trực tiếp cho nhà máy Hải Phòng của VinFast nếu bạn cần thông tin chi tiết hơn không?

## Sources

### [1] VinFast Auto Q4 2025 Earnings Report - MarketBeat

> Le Thi Thu Thuy Chairwoman of the Board of Directors at VinFast Auto 00:55:06 From the supply chain perspective, we have developed a global supplier network of 1,700 partners and about 800 direct suppliers that are, you know, ready to supply to us. Well, I think, on your second question, beyond pricing, we differentiate through our EV ecosystem, including the rollout of the V-GREEN charging infrastructure, and the expansion of GSM ride-hailing fleet, which help build the long-term consumer confidence. Over time, our scale increases and our ecosystem matures. We expect, you know, promotions to normalize with differentiation increasingly driven by great value to money, the vehicle products, and enhanced ownership experience and after-sales service, and, of course, the best-in-class warranty coverage.
...
### [4] Preliminary and unaudited financial results for the fourth quarter and full year ended December 31, 2025 - SEC.gov
...
### [5] VinFast Auto Q4 2025 Earnings Report - MarketBeat
...
### [6] VinFast Auto Q4 2025 Earnings Report - MarketBeat
...
### [10] Báo cáo phân tích chuyên sâu: Chuỗi cung ứng xe điện toàn cầu, quy tắc xuất xứ hàng hóa, năng lực tài chính và công nghệ sản xuất pin giai đoạn 2025-2026
...
### [11] Gotion High-tech and VinES Vietnam base break ground at joint venture battery factory
...
### [12] Gotion High-tech and VinES Vietnam base break ground at joint venture battery factory

> The factory was jointly invested by Gotion High-tech, and VinES (a member of VinGroup). Gotion High-tech holds 51% of the shares and VinES holds 49%. It is the first LFP battery manufacturing plant in Vietnam. According to the plan, The project has a scale of 14 hectares with a design capacity of 5GWh/year, and is expected to be completed and put into operation by the end of 2023. To meet the demand of lithium iron phosphate batteries for VinFast new energy vehicle batteries. VinES is owned by VinGroup, Vietnam's largest private company, and is mainly responsible for power battery production.The group's VinFast, is the world's leading new energy vehicle manufacturing enterprise, whose products are widely praised in the Southeast Asia market and exported to Europe and America.

### [13] Preliminary and unaudited financial results for the fourth quarter and full year ended December 31, 2025 - SEC.gov

> ● As of December 31, 2025, VinFast operates four manufacturing facilities globally with a combined maximum annual capacity of approximately 600,000 EVs, consisting of 300,000 EVs p.a. in Hai Phong and 200,000 EVs p.a. in Ha Tinh (Vietnam), 50,000 EVs p.a. in Indonesia, and 50,000 EVs p.a. in India. The Company also manufactures e-scooters in Hai Phong with an annual capacity of approximately 500,000 units. ● Smart manufacturing is central to the Company's longer-term profitability. Within the Vingroup ecosystem, VinFast is working closely with an affiliated company, VinRobotics, which focuses on the development of intelligent robotics, automation systems and physical AI technologies for industrial applications. VinRobotics' platform includes industrial humanoid robots and AI-enabled automation layers designed to operate in complex factory environments, enabling higher levels of automation and productivity. VinFast's collaboration with VinRobotics focuses on improving factory productivity, quality control and operational efficiency, supporting higher utilization and increased automation as production volumes scale, and contributing to structural improvements in the Company's cost base. In the future, VinFast expects to be the manufacturing partner for VinRobotics, as well as for two other robotics companies within the Vingroup ecosystem, VinMotion and VinDynamics.

### [14] VinFast Reports Preliminary and Unaudited Fourth Quarter and Full Year 2025 Financial Results
...
### [15] THACO INDUSTRIES phát triển Trung tâm sản xuất linh kiện phụ tùng mang tầm khu vực
...
### [16] THACO INDUSTRIES phát triển Trung tâm sản xuất linh kiện phụ tùng mang tầm khu vực
...
### [17] Ôtô 'nội' tăng liên tục, tỷ lệ nội địa hóa ra sao? - Báo Mới
...
### [20] Gotion High-tech and VinES Vietnam base break ground at joint venture battery factory

> Gotion High-tech and VinES Vietnam base break ground at joint venture battery factory USA - English USA - Français USA - Deutsch USA - español Latin America - español Brazil - Português USA - English News provided by Gotion High-Tech Nov 21, 2022, 00:16 ET Share this article [ ](javascript:;) [ ](javascript:;) [ ](javascript:;) [ ](javascript:;) [ ](javascript:;) Share to X Share this article [ ](javascript:;) [ ](javascript:;) [ ](javascript:;) [ ](javascript:;) Share to X HA TINH, Vietnam, Nov. 21, 2022 /PRNewswire/ -- November 18, the joint venture battery factory by Gotion High-Tech and Vietnam VinGroup was officially opened in Vietnam Ha Tinh Economic Development Zone. The project is expected to achieve annual production capacity of 5GWh, expected to be in operation by the end of 2023, which is the first LFP battery factory in Vietnam.

### [22] VinES and Gotion High-Tech Break Ground at a 5GWh/Year LFP Battery Factory
...
### [23] Báo cáo phân tích chuyên sâu: Chuỗi cung ứng xe điện toàn cầu, quy tắc xuất xứ hàng hóa, năng lực tài chính và công nghệ sản xuất pin giai đoạn 2025-2026
...
### [24] Gotion building Vietnam's first LFP gigafactory - Energy-Storage.News

> Lithium iron phosphate has become an increasingly popular battery sub-chemistry for stationary energy storage systems, eroding the early market dominance of nickel manganese cobalt (NMC). While lower energy density than NMC, it is also lower cost and tied to more abundantly available cathode materials, meaning EV makers increasingly also turn to it , particularly for shorter range and lower cost vehicles. Gotion-VinES' factory will go into mass production in Q3 2024, creating around 500 jobs. It will follow VinES' own 8-hectare packing and production plant, which goes into operation next month.

### [27] Ha Tinh's Industrial Sector Shines in the First Half of 2025 - Trung tâm DVTC & HTDN Tỉnh Hà Tĩnh

> In the first half of the year, the Vung Ang Economic Zone saw vibrant production activities. Two major battery manufacturing plants, VinES Ha Tinh and the VinES-Gotion Lithium Battery Joint Venture, operated at high and stable capacity, meeting the growing demand in the electric vehicle manufacturing industry. Deputy Prime Minister Inaugurates VinFast Electric Vehicle Manufacturing Plant in June 2025 The VinFast Electric Vehicle Manufacturing Plant in Ha Tinh, invested in by Vingroup, was inaugurated in late June and began operations, marking a significant milestone in the province's green industrial production ecosystem. With an initial design capacity of approximately 200,000 vehicles per year, the plant is expected to boost provincial tax revenues and promote the development of a production-supply-logistics value chain in the region. This aligns with Ha Tinh's vision for green growth and sustainable development as outlined in the Provincial Plan for 2021–2030, with a vision to 2050.

### [28] VinFast Reports Preliminary and Unaudited Fourth Quarter and Full Year 2025 Financial Results

> Manufacturing Milestones: The Company's manufacturing utilization and operational efficiency continued to improve at its largest plant in Hai Phong, Vietnam. The facility celebrated the 200,000th EV of the year rolling off the assembly line on December 31, 2025, and produced nearly 26,000 EVs in December 2025 alone. In June 2025, VinFast officially inaugurated the VinFast Ha Tinh electric vehicle manufacturing plant in the Vung Ang Economic Zone, less than seven months after the project was initiated.

### [29] VINFAST REPORTS DELIVERIES OF 17955 ELECTRIC VEHICLES IN JUNE 2026 IN VIETNAM, REACHING A RECORD OF 115916 ELECTRIC VEHICLES IN THE FIRST HALF OF 2026

> VINFAST REPORTS DELIVERIES OF 17,955 ELECTRIC VEHICLES IN JUNE 2026 IN VIETNAM, REACHING A RECORD OF 115,916 ELECTRIC VEHICLES IN THE FIRST HALF OF 2026 | VinFast VinFastVinFast VinFast Videos Our Reports News & Events Governance SEC Filings Stock Sustainability FAQs VinFast Videos Back News News VINFAST REPORTS DELIVERIES OF 17,955 ELECTRIC VEHICLES IN JUNE 2026 IN VIETNAM, REACHING A RECORD OF 115,916 ELECTRIC VEHICLES IN THE FIRST HALF OF 2026 July 11, 2026 Hanoi, July 10, 2026 – VinFast Auto Ltd. (“VinFast” or the “Company”) announced preliminary domestic Vietnam deliveries of 17,955 electric vehicles (“EVs”) for June 2026. Year to date, the Company has delivered a preliminary total of 115,916 EVs to customers in Vietnam, representing a significant increase of 72% compared to the same period last year, reaffirming its leadership in the domestic automotive market and marking the first time an automotive brand has exceeded 100,000 vehicle deliveries in the first half of a calendar year in Vietnam.

### [30] VinFast (NASDAQ: VFS) reports 115916 EV deliveries and 72% growth in H1 2026

> (Neutral) Form Type 6-K Rhea-AI Filing Summary English Italian Spanish German Korean French Arabic VinFast Auto Ltd. reported preliminary domestic Vietnam deliveries of 17,955 electric vehicles in June 2026 and a record 115,916 EVs in the first half of 2026. This first-half volume represents a 72% increase compared to the same period last year and is described as the first time an automotive brand has exceeded 100,000 vehicle deliveries in the first half of a calendar year in Vietnam. In June, Limo Green was the top model with 3,868 deliveries, followed by VF 3 with 3,550, VF 5 and Herio Green combined with 3,364, VF 6 with 2,988, VF 7 with 1,437 and VF MPV 7 with 1,254. For the first half of 2026, Limo Green and VF 3 reached 27,927 and 23,781 deliveries, respectively. VinFast also highlighted the launch of the VF 2 compact urban EV in Vietnam, with deliveries expected to begin in September 2026, and noted that delivery figures are preliminary and one of several measures of performance.

### [31] Báo cáo phân tích chuyên sâu: Chuỗi cung ứng xe điện toàn cầu, quy tắc xuất xứ hàng hóa, năng lực tài chính và công nghệ sản xuất pin giai đoạn 2025-2026
...
### [32] Miễn lệ phí trước bạ đến năm 2030, người mua xe điện tiết kiệm cả trăm triệu đồng

> xem thêm World Cup 2026 Video Photo Longform Infographic Lý tưởng sống Nói thẳng Tin độc quyền Thị trường Liên hệ Thông tin toà soạn Dịch vụ truyền thông 1 Kinh tế Miễn lệ phí trước bạ đến năm 2030, người mua xe điện tiết kiệm cả trăm triệu đồng Minh Phong 09/06/2026 12:49 GMT+7 Chia sẻ (NLĐO)- Chính phủ chính thức gia hạn miễn lệ phí trước bạ cho ô tô điện chạy pin đến hết năm 2030. Chính phủ vừa ban hành Nghị định 202 ngày 8-6 sửa đổi, bổ sung một số điều của Nghị định 10 năm 2022 quy định về lệ phí trước bạ, trong đó tiếp tục áp dụng mức thu lệ phí trước bạ lần đầu 0% đối với ô tô điện chạy pin đến hết ngày 31-12-2030. Theo nghị định, việc phân loại xe điện được thực hiện theo quy định của Bộ trưởng Bộ Xây dựng.
...
### [34] Ô tô điện được miễn lệ phí trước bạ lần đầu đến hết 2030 - VTV.vn

> Trong đó, thuế tiêu thụ đặc biệt với xe điện dưới 9 chỗ duy trì ở mức 3% tới hết 2030. Từ năm 2031, thuế này với các loại xe điện dự kiến tăng gấp 3,5-4 lần Tin liên quan Đề xuất miễn lệ phí trước bạ ô tô điện đến hết năm 2030 VTV.vn - Bộ Tài chính đang dự thảo Nghị định sửa đổi, bổ sung một số điều của Nghị định số 10/2022/NĐ-CP ngày 15/01/2022 của Chính phủ quy định về lệ phí trước bạ.

### [35] Miễn lệ phí trước bạ đến năm 2030, người mua xe điện tiết kiệm cả trăm triệu đồng

> Đề xuất mới về mức đóng lệ phí trước bạ, người mua xe điện hưởng lợi Bộ Tài chính cho biết, chính sách ưu đãi lệ phí trước bạ đối với ô tô điện chạy pin được triển khai từ năm 2022 nhằm góp phần giảm thiểu ô nhiễm môi trường do khí thải giao thông, khuyến khích doanh nghiệp đầu tư sản xuất, tận dụng cơ hội trong chuỗi cung ứng và thúc đẩy người dân sử dụng phương tiện thân thiện với môi trường.
