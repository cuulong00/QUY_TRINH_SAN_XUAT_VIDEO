...
| "vạn", "hàng chục vạn", "vài vạn" | Lỗi dịch thô Hán-Việt từ tiếng Trung (bệnh dịch máy). Tiếng Việt chuẩn mực hiện đại không dùng "hàng chục vạn", nghe ngô nghê và mất tự nhiên. | "hàng trăm nghìn", "vài trăm nghìn", "hàng chục nghìn" |
| "đè bẹp" | Quá kích động, cảm tính và bạo lực (sensationalist), làm mất đi vẻ điềm tĩnh, khách quan khi mổ xẻ cơ chế thị trường của một chuyên gia kinh tế. | "hoàn toàn thất thế về giá", "mất hoàn toàn lợi thế cạnh tranh về giá", "bị lấn át về giá" |
