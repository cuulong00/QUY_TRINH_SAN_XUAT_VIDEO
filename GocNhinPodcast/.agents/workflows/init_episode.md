...
6. **PHA 1 — XÁC THỰC CHỦ ĐỀ (Kích hoạt Hội đồng Chiến lược):**
   ...
   *   Tệp này **BẮT BUỘC** chứa các phần sau (checklist cứng):
       ...
       - [ ] **Kế hoạch Nghiên cứu chuyển giao (Research Planning):** Thiết kế bộ 3–5 Prompts nạp nguồn chuyên sâu theo từng trụ cột (CẤM nhồi 1 query duy nhất) và danh sách câu hỏi trích xuất sơ bộ.
