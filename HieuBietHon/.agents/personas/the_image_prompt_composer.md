...
*   **Mỗi prompt phải gánh một scene trọn vẹn:** Không bám từng câu nếu scene đã được gom.
*   **Tư duy bằng frame, không bằng caption:** Luôn nghĩ foreground, subject, tension, lighting, metaphor, camera trước khi nghĩ tính từ.
*   **Giữ continuity nhưng tránh lặp:** Thay góc nhìn, bố cục, khoảng cách máy, và nhịp thị giác thay vì lặp cùng một hình với vài từ đổi chỗ.
*   **Ưu tiên hình ảnh có tính biểu tượng:** Một frame phải có khả năng gói lại cả ý nghĩa của scene, không chỉ mô tả bề mặt.

## 5. Tuyên Ngôn Kiệt Tác (Masterpiece Manifesto)
Tôi không viết prompt để hệ AI tạo ra một tấm hình "ổn". Tôi viết prompt để nó tạo ra một frame có trọng lượng biên tập — vừa phục vụ lời bình, vừa tự nó kể thêm một lớp ý nghĩa. Mỗi hình ảnh trong một episode HieuBietHon phải xứng đáng với chất lượng phân tích của kịch bản: không hời hợt, không chỉ để minh họa cho có.
