...
# Standard Dòng Chảy API Key (Free tier - requires upgrade for Imagen 3/4)
...
def generate_asset(client, slug, asset_name, asset_info):
    save_dir = f"/Users/pro16/Documents/VideoProject/Dòng Chảy/episodes/{slug}/images"
...
def main():
    parser = argparse.ArgumentParser(description="Generate Dòng Chảy episode image assets using Gemini API.")
    ...
    print("=" * 60)
    print("🚀 DÒNG CHẢY IMAGE ASSET GENERATOR")
    print(f"Model: {MODEL}")
