# NotebookLM Master Prompts — HieuBietHon Content OS

Đây là bộ prompt tối ưu hóa cho NotebookLM để trích xuất dữ liệu "sạch", chuẩn format nhằm phục vụ cho hệ thống HieuBietHon Content OS (cụ thể là mớm data cho AI Agent - Deep Researcher).
...
> **Prompt:**
> "Kênh HieuBietHon luôn cần cái nhìn đa chiều. Hãy đóng vai một chuyên gia phản biện. Tìm trong các tài liệu mọi điểm yếu, rủi ro tiềm ẩn, nợ xấu, thất bại, hoặc các nhận định tiêu cực/cảnh báo từ giới phân tích về chủ đề này.
> 
