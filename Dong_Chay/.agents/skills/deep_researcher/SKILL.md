...
# Deep Researcher — Nhà Nghiên Cứu Chuyên Sâu (Dòng Chảy)
...
> `[Absolute Path: /Users/pro16/Documents/VideoProject/Dong_Chay/.agents/personas/the_socio_economic_researcher.md]`
>
...
* **Thư mục Profile / Session:** `NOTEBOOKLM_HOME=/Users/pro16/Documents/VideoProject/Dong_Chay/.notebooklm_home`
* **Đường dẫn CLI:** `/Users/pro16/Documents/VideoProject/Dong_Chay/.venv/bin/notebooklm`
* **Python Executable:** `/Users/pro16/Documents/VideoProject/Dong_Chay/.venv/bin/python`
...
> 2. **1 VIDEO = 1 MASTER NOTEBOOK DUY NHẤT:** Sử dụng `notebooklm-py` Direct RPC (chạy trong `.venv`) để tạo 1 Master Notebook duy nhất cho episode. Ghi `notebook_id` vào `episodes/[slug]/.notebook_id`.
