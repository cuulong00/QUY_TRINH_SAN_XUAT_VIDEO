...
def try_gemini_translation(english_segments):
    ...
    try:
        ...
        prompt = f"""
        Bạn là biên dịch viên kịch bản tài chính - kinh tế của kênh HieuBietHon.
...
def main():
    parser = argparse.ArgumentParser(description="HieuBietHon Dubbing Pipeline CLI")
