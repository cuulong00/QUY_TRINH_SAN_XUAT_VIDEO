    ...
    try {
      ...
      try {
        ...
        try {
          ...
          await page.screenshot({ path: path.join(CONFIG.dataDir, 'debug-homepage.png'), fullPage: true });
          log.warning(`  📸 Screenshot saved to ${path.join(CONFIG.dataDir, 'debug-homepage.png')}`);
        }
