...
async function main() {
  ...
  const vaultDir = '/Users/pro16/Documents/VideoProject/GocNhinPodcast/episodes/vinfast-an-do/research_vault';
...
`;
  ...
  try {
    await page.screenshot({ path: `/Users/pro16/Documents/VideoProject/GocNhinPodcast/scratch/extraction_progress_${q.id}.png` });
  } catch {}
