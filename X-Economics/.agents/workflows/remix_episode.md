---
description: Tuyến Remix — Tạo kịch bản mới từ video YouTube có sẵn, viết lại sáng tạo theo voice GocNhinPodcast
---
...
3. Lập bảng phân tích theo template trong guide:
   ...
   - So sánh đối tượng video gốc vs đối tượng GocNhinPodcast
...
2. **QUY TẮC ĐẶC BIỆT CHO REMIX:**
   ...
   - Viết lại hoàn toàn bằng voice GocNhinPodcast
...
5. Cập nhật 3 file state sau mỗi chương: `09_narrative_state_tracker.md`, `06_claim_ledger.md`, `07_golden_lines.md`.
