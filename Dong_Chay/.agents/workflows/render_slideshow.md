...
- The operator manually imports all assets into CapCut, syncs them on the timeline, and exports to `video/slideshow_base.mp4` (preserving this filename for repository validator compatibility).
