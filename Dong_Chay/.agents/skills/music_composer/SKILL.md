...
> `[Absolute Path: /Users/pro16/Documents/VideoProject/Dòng Chảy/.agents/personas/the_cinematic_sonic_alchemist.md]`
>
...
- các tệp `chapter_XX.md` (đọc tuần tự từ chapter_01 → chapter cuối)
- `episodes/[slug]/06_retention_map.md`
- `episodes/[slug]/production_notes.md`

Nếu đã có `scene_timing_map.json` hoặc `visual_map.csv`, phải đọc để nhạc bám đúng nhịp hình và nhịp ý.
