...
def try_gemini_translation(english_segments):
    ...
    try:
        ...
        prompt = f"""
        Bạn là biên dịch viên kịch bản tài chính - kinh tế của kênh KenhTamLy.
...
def main():
    parser = argparse.ArgumentParser(description="KenhTamLy Dubbing Pipeline CLI")
