# Thư Mục Quản Lý Video Tuyên Bố Trách Nhiệm (Disclaimer Assets)
**Kênh:** DONGCHAY  
...
1. **`tuyenbo_trachnhiem_dongchay.mp4`** *(Bản Master hoàn chỉnh)*:
...
2. **`tuyenbo_trachnhiem_dongchay_clean_audio.mp4`** *(Bản Vocal sạch không nhạc nền)*:
...
3. **`tuyenbo_trachnhiem_dongchay_anh_tuyenbo_mientru.png`** / **`tuyenbo_trachnhiem_dongchay_poster.png`** *(Ảnh Tĩnh Độ Nét Cao Không Nén)*:
...
4. **`tuyenbo_trachnhiem_dongchay_anh_tuyenbo_mientru.jpg`** / **`tuyenbo_trachnhiem_dongchay_poster.jpg`** *(Ảnh Tĩnh JPG 98% chất lượng)*:
