...
**The Math of Time (Giao thức Đồng bộ Toán học cho Veo 3.1):** Mỗi scene sinh ra mặc định dài 8.0 giây. Tốc độ đọc tiếng Việt trung bình của narrator kênh Dòng Chảy là 3.81 từ/giây. Do đó, một phân cảnh đơn hoặc phân cảnh phụ tuyệt đối không được chứa quá 26 từ thoại. Nếu cụm câu thoại dài hơn 26 từ, bắt buộc phải chia nhỏ thành $K = \lceil W / 26 \rceil$ phân cảnh phụ (`a1`, `a2`, `a3`...) và phân bổ đều số từ thoại sang các cảnh phụ đó. Nghiêm cấm để các phân cảnh phụ có thoại rỗng `[]` khi cảnh trước bị quá tải từ (>26 từ).
