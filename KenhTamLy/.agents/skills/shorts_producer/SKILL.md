...
> `[Absolute Path: /Users/pro16/Documents/VideoProject/KenhTamLy/.agents/personas/the_shorts_strategist.md]`
...
5. Giữ giọng KenhTamLy ở dạng nén, không biến thành tin tức đọc nhanh.
...
- **Đại Diện Chuyên Trách Hình Ảnh Dọc:** Bất kỳ khi nào Sếp ra lệnh tạo Prompt Hình Ảnh/Video (visual_prompts) cho Shorts, HỆ THỐNG BẮT BUỘC PHẢI LOAD VÀ HÓA THÂN thành `[Absolute Path: /Users/pro16/Documents/VideoProject/KenhTamLy/.agents/personas/the_shorts_strategist.md]`.
