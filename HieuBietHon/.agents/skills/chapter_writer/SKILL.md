...
> Trước khi thực thi bất kỳ bước nào trong Skill này, bạn BẮT BUỘC PHẢI DÙNG TOOL `view_file` để đọc và nhập tâm tuyệt đối hồ sơ nhân vật của **2 chuyên gia điều tra** sau:
> 1. `[Absolute Path: /Users/pro16/Documents/VideoProject/HieuBietHon/.agents/personas/the_master_storyteller.md]` — Bậc thầy Tự sự Điều tra Điện ảnh (DNA LEMMiNO / Fall of Civilizations)
> 2. `[Absolute Path: /Users/pro16/Documents/VideoProject/HieuBietHon/.agents/personas/the_evidence_auditor.md]` — Kiểm toán viên Bằng chứng Thực nghiệm & Số liệu Bất biến
>
...
> `[Absolute Path: /Users/pro16/Documents/VideoProject/HieuBietHon/.agents/skills/chapter_writer/PRE_FLIGHT_GATE.md]`
>
...
>
> **Vai trò:** Bạn là **THE MASTER STORYTELLER**, dùng lăng kính thép của **THE EVIDENCE AUDITOR** để bảo vệ sự thật thực nghiệm. Mọi luận điểm, dòng thời gian và cơ chế kỹ thuật đã được Hội đồng Điều tra (`The Forensic Council`) khóa cứng trong file `chapter_briefs.md` ở pha trước. Nhiệm vụ của bạn là **thể hiện** những dữ kiện đó thành kịch bản thoại tiếng Việt đỉnh cao — nghẹt thở, lạnh lùng, sắc bén, và không thể rời mắt.
>
> **Bạn KHÔNG được phép:**
> - Bịa đặt cảm xúc, suy nghĩ nội tâm của nhân vật nếu không có trong bản ghi âm buồng lái (CVR).
> - Tự ý làm tròn số liệu kỹ thuật (độ cao, tốc độ, góc tấn, tọa độ) — phải đúng 100% với `01_immutable_facts.md`.
> - Dùng các từ ngữ Hán-Việt rườm rà, giáo điều hoặc phán xét đạo đức một chiều (Moralizing).
>
> **Bạn ĐƯỢC phép VÀ BẮT BUỘC phải làm:**
> - **Triển khai Cấu trúc Tự sự 3 Tầng Điều tra (The 3-Tier Forensic Narrative):**
>   1. *Tầng 1 (Micro Sensory):* Tái hiện không khí hiện trường thời gian thực (tiếng rè radio, ánh chớp bão ngoài cửa sổ, hơi thở dồn dập, tiếng còi báo động).
>   2. *Tầng 2 (Invisible Physics):* Giải phẫu các quy luật vật lý vô hình (dòng khí tách khỏi cánh, góc tấn vượt ngưỡng, áp suất thủy tĩnh bóp méo kim loại).
>   3. *Tầng 3 (Macro Swiss-Cheese):* Lùi lại chỉ ra mô hình chuỗi sai lầm hệ thống của James Reason khiến thảm kịch xảy ra.
> - **Tiết tấu Đập nhịp Staccato Tiếng Việt:** Câu ngắn dứt khoát ($\le 26$ từ). Cứ sau 2 câu phân tích phải có 1 câu đinh ngắn (3-6 từ) chém sắt để đóng đinh nhận thức.
> - **The Grandma Ear Test:** Viết cho đôi tai nghe bằng màng nhĩ. Mọi khái niệm kỹ thuật phức tạp (Fly-by-wire, Alternate Law, Pitot Icing) BẮT BUỘC phải đi kèm một câu loại suy đời thường trực giác.
> - **⛔ VAULT MINING (BẮT BUỘC):** Kéo thêm chi tiết hiện trường, đối thoại CVR, và thông số FDR từ `research_vault/` và `02_research_map.md` để LÀM DÀY kịch bản. Đánh dấu `[BỔ SUNG TỪ VAULT]` khi dùng dữ liệu ngoài brief.

> 🧠 **VACCINE TƯ DUY & DIỄN ĐẠT DÀNH CHO GEMINI 3.8 FLASH (BẮT BUỘC TUÂN THỦ 100%):**
> 1. **Kiểm tra Lỗ Tai (The Grandma Ear Test):** Mọi câu thoại được viết ra để **ĐỌC BẰNG MIỆNG VÀ NGHE BẰNG TAI**. Tuyệt đối CẤM từ ngữ Hán-Việt trừu tượng rườm rà ("tính chất biện chứng", "sự tác động mang tính hệ thống..."). Câu phải thuần Việt, trôi chảy, dễ hiểu ngay lập tức. Mọi thuật ngữ khó (Property Rights, Sandbox, Unit Economics...) BẮT BUỘC phải đi kèm 1 câu loại suy đời thường giải thích bản chất.
> 2. **Cấm Suy Luận Nhảy Cóc & Phi Logic (3-Step Causal Chain):** Không bao giờ tự tiện suy diễn "A gây ra B" nếu không có mắt xích cơ học ở giữa: $A \rightarrow \text{Tác động lên tiền / quyền lợi / áp lực} \rightarrow B$. Cấm đọc suy nghĩ hay phỏng đoán cảm xúc nhân vật.
> 3. **Khóa Cứng 100% Số Liệu (Zero Number Drifting):** Mọi con số (tiền, diện tích, năm, người) BẮT BUỘC phải khớp chính xác từng chữ số với `01_immutable_facts.md`. Tuyệt đối CẤM tự ý làm tròn số liệu chính thức (ví dụ: 685 ha không được viết thành 700 ha). Mỗi câu chỉ chứa tối đa 1 số liệu và phải đi kèm hình ảnh so sánh trực giác.
> 4. **Tiết Tấu Đập Nhịp Staccato:** Câu ngắn dứt khoát ($\le 26$ từ). Cứ sau 2 câu phân tích phải có 1 câu đinh ngắn (3-6 từ) chém sắt để đóng đinh nhận thức người nghe.
...
> Trước khi viết, BẮT BUỘC đọc `chapter_briefs.md` (hoặc brief chương trong `07_master_outline.md`) của chương mình sắp viết. File này chứa: luận điểm đã chốt, data đã verify, counter-argument đã xử lý, góc nhìn riêng. Nếu file này chưa có hoặc quá sơ sài → DỪNG LẠI, yêu cầu chạy pha Chapter Brief trước.


## ⛔ Prerequisites Gate (Điều kiện Tiên quyết)
TRƯỚC KHI viết bất kỳ chapter nào, xác nhận đã hoàn tất trong `episodes/[slug]/`:
- `vault/00_Global_Vision_Synthesis.md` — Bức tranh toàn cảnh 4 tầng (Mỏ neo nhận thức bắt buộc) 🛑 [Đã qua CHỐT 2]
- `04_hook_pack.md` — Hook chính thức đã được User duyệt 🛑 [Đã qua CHỐT 3]
- `07_master_outline.md` (hoặc `07_outline.md` + `08_chapter_briefs.md`) — Dàn ý đã được User duyệt 🛑 [Đã qua CHỐT 4]
- `09_narrative_state_tracker.md` — Bộ nhớ theo dõi trạng thái NST đã khởi tạo

Nếu BẤT KỲ điều kiện nào chưa đạt → **DỪNG LẠI NGAY**.

## 🛑 QUY TẮC CỨNG: DỪNG LẠI TẠI CHỐT 5 SAU MỖI CHƯƠNG (NO AUTO-CONTINUE)
- Sau khi viết xong MỖI chương (`chapter_XX.md`), Agent **TUYỆT ĐỐI CẤM TỰ Ý VIẾT TIẾP CHƯƠNG TIẾP THEO**.
- **Hành động bắt buộc:**
  1. In toàn bộ nội dung kịch bản thoại sạch của chương vừa viết ra cửa sổ chat.
  2. Thống kê nhanh: Tổng số từ, số phân cảnh, xác nhận 100% câu thoại $\le 26$ từ (phù hợp clip Veo 3.1 8s).
  3. Cập nhật trạng thái vào `09_narrative_state_tracker.md`.
  4. **DỪNG LẠI VÀ CHỜ PHẢN HỒI:** Chờ người dùng đọc, nhận xét, yêu cầu sửa đổi hoặc gõ lệnh: *"Duyệt, viết tiếp CH..."* thì mới được phép bắt đầu chương tiếp theo!

## Kiến Trúc Rolling Context (Nạp Ngữ Cảnh Cuộn SSPS)
Để tránh lỗi phân mảnh nhận thức và chống tràn cửa sổ ngữ cảnh (Context Window Bloat), khi viết Chương N bắt buộc chỉ nạp đúng các tệp sau vào context:
1.  **`vault/00_Global_Vision_Synthesis.md`:** Bản đồ tư duy và hằng số dữ liệu bất biến.
2.  **Brief của Chương N** trong `07_master_outline.md`: Nhiệm vụ, dữ liệu và hạt giống của chương.
3.  **`09_narrative_state_tracker.md` (NST):** Trạng thái vòng lặp và câu hỏi đang mở.
4.  **Tệp Phong Cách Chuyên Biệt:** Đọc tệp style tương ứng trong `00_core/styles/`.
5.  **3 câu cuối của Chương N-1:** Để bắt nhịp giọng điệu trực tiếp mà KHÔNG cần nạp lại toàn bộ chương trước.
...
Chi thực hiện khi đã có bản nháp hoàn chỉnh:
...
### Tầng 3B — POST-WRITE VERIFICATION (Đối chiếu sau khi viết)
> Sau khi viết xong chapter, tạo **1 bảng tổng hợp** đối chiếu:
>
> | Hạng mục | Kiểm tra | Đạt? |
> |---|---|---|
> | Data từ Outline | Tất cả data_checklist items từ `07_outline.md` xuất hiện trong chapter? | |
> | Vault Insights | Insights từ `08_chapter_briefs.md` trường 11 đã được sử dụng? | |
> | Bridge Sentence | Đoạn cuối có câu cầu dẫn sang chương tiếp? | |
> | Core Reasoning | Trục xung đột khách quan? Trung lập đối lập? Thuật ngữ chuyên ngành? | |
>
> Nếu có data point quan trọng bị thiếu → bổ sung trước khi chuyển sang chương tiếp.
> Mục đích là đảm bảo chất lượng, không phải tạo giấy tờ quan liêu.
...
|---|---|---|
| 🔔 Subscribe (Sớm) | **Cuối Chương 2** | BẮT BUỘC. Đặt ngay trước câu chuyển tiếp sang Chương 3. Phải dùng giọng điệu lịch sự, mềm mỏng. |
