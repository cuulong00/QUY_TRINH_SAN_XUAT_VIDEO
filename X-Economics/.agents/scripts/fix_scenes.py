...
for i, ch in enumerate(chapters):
    path = os.path.join("/Users/pro16/Documents/VideoProject/X-Economics/episodes/nghich-ly-gia-xang-viet-nam/", ch)
...
with open("/Users/pro16/Documents/VideoProject/X-Economics/episodes/nghich-ly-gia-xang-viet-nam/scene_timing_map.json", "w", encoding="utf-8") as f:
