...
11. Chạy `10_compliance_report.md`
12. Tạo `scene_timing_map.json`, `visual_storyboard_blueprint.md` & `prompts_chapter_XX.txt` (Chỉ khi có yêu cầu)
13. Khi đã có thư mục ảnh final, render `video/slideshow_base.mp4`
14. Hoàn tất `production_notes.md`
15. Sau publish hoặc review nội bộ, ghi `postmortem.md`
...
- `scene_timing_map.json` & `visual_storyboard_blueprint.md` (Pha 12 — Chỉ khi có yêu cầu)
- `production_notes.md`
- `postmortem.md`
