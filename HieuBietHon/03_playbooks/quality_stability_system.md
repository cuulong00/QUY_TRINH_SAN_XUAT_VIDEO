...
## 5. Encode learnings
Mỗi khi phát hiện lỗi lặp, lỗi tone, lỗi an toàn biên tập/pháp lý, lỗi retention, phải thêm vào `lessons_learned.md` hoặc cập nhật file lõi.
...
- No public commentary without compliance.
- No phase skipping.
