...
> **Kênh:** X-Economics
> **Mục đích tài liệu:** Quản trị tập trung toàn bộ các khuyết tật, lỗi lặp lại và phản hồi từ chối của Người dùng từ tất cả các tập video trong hệ sinh thái **X-Economics**.
...
1. **Câu dài vượt giới hạn âm thanh (>150 ký tự):** Mô hình viết câu phức khi phân tích mô hình tài chính/chuỗi cung ứng vĩ mô, gây đứt hơi cho TTS.
...
3. **Cắt xén cơ chế kỹ thuật (Mechanism Amputation):** Khi bị ép số từ, mô hình cắt bớt các bước suy luận dòng tiền/bản chất cơ cấu nợ.
4. **Ảo giác số liệu báo cáo tài chính (Financial Data Hallucination):** Nhầm lẫn giữa doanh thu vs lợi nhuận gộp, vốn cam kết vs vốn giải ngân thực tế.
5. **Scaffolding Leakage:** Vô tình in tên block hoặc nhãn phân tích vào kịch bản thành phẩm.
