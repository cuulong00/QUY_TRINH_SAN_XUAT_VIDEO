...
async function main() {
  ...
  if (page) {
    ...
    await page.screenshot({ path: '/Users/pro16/Documents/VideoProject/GocNhinPodcast/scratch/pre_query_chat_state.png' });
    ...
    fs.writeFileSync('/Users/pro16/Documents/VideoProject/GocNhinPodcast/scratch/notebooklm_current_chat_content.txt', pageText);
  } else {
