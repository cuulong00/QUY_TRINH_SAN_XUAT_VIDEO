# /deep_research — Nghiên cứu sâu NotebookLM (Hiểu Biết Hơn)
...
1. `view_file` → `/Users/pro16/Documents/VideoProject/HieuBietHon/.agents/personas/the_socio_economic_researcher.md`
2. `view_file` → `/Users/pro16/Documents/VideoProject/HieuBietHon/.agents/skills/deep_researcher/SKILL.md`
3. `view_file` → `/Users/pro16/Documents/VideoProject/HieuBietHon/.agents/skills/notebooklm_librarian/SKILL.md`
