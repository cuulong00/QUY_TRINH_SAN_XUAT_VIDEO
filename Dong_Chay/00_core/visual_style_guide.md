# Visual Style Guide — Kênh Dòng Chảy (I2V Reference Asset Protocol & S-Grade Cinematic Video)

> **Kênh:** Dòng Chảy — Phân tích kinh tế vĩ mô, dòng tiền, doanh nghiệp và chính sách tài chính cho người Việt
...
*   **Tuyển vai Biểu tượng (Iconic Casting Mandate):** Ưu tiên số 1 là con người (các tài phiệt, lãnh đạo tập đoàn công nghiệp/công nghệ như Phạm Nhật Vượng, Trần Đình Long, Trương Gia Bình, Vương Truyền Phúc, Elon Musk; các thống đốc ngân hàng trung ương, bộ trưởng, nhà điều hành kinh tế). Việc đưa nhân vật biểu tượng có thật vào đúng phân cảnh mang lại sức nặng chính luận, sự uy tín và tính thuyết phục tuyệt đối. (Các công trình, địa danh nổi tiếng đã có sẵn trong dữ liệu huấn luyện của Nano Banana 2 nên không bắt buộc cần ảnh tham chiếu, trừ máy móc/linh kiện công nghiệp độc quyền).
...
Tuyệt đối cấm sử dụng các dải màu cầu vồng tự do hoặc cụm từ "vibrant color palette" thiếu định hướng. Đồng thời **TUYỆT ĐỐI CẤM phong cách u ám, tối tăm (No Pitch-Black / Grim Shadows)** như nền than đen kịt `#1A1A1A` hay `deep noir chiaroscuro shadows`.

### 1. Bảng Màu Nền & Chủ Đạo (60%)
- **Tông Ngà Kem Ấm Áp (Warm Ivory Cream - Ưu tiên hàng đầu cho chiều sâu báo chí tài chính):** `warm ivory cream ambient tone (#FAF7EE)`, tạo cảm giác trang nhã, học thuật, như trang báo tài chính quốc tế (Financial Times, The Economist).
- **Tông Slate Hiện Đại (Modern Slate):** `#2A323D`, `#2C3539`, `#1E293B` mang lại cảm giác công nghệ cao, vững chãi, uy tín doanh nghiệp.
...
- *Cảnh báo / Khủng hoảng / Nợ xấu / Rủi ro:* `crimson coral red` (`#EF5350`) hoặc `deep warning orange` (`#FF7043`).
...
- Tránh xa các hiệu ứng tối tăm, mờ mịt gây cảm giác u buồn hay nặng nề tiêu cực.

---

## 📉 TƯ DUY ẨN DỤ VẬT LÝ & 100% HIỆN THỰC VẬT LÝ

Tuyệt đối cấm các hình ảnh siêu thực, trừu tượng không có thật ngoài đời (cái cân bay, bàn tay thép, hố sâu chi phí, quả cầu trong hư vô, bánh răng bay lơ lửng, bàn cờ quân cờ). Mọi khái niệm tài chính - vĩ mô phải được thể hiện qua **hành động vật lý và bối cảnh đời thực**:
- **Chính sách vĩ mô & Dòng tiền:** Lãnh đạo ngân hàng trung ương và chuyên gia họp bàn quanh văn bản chính sách, báo cáo tài chính in giấy thật trên bàn gỗ, phòng hội thảo quốc tế.
- **Sản xuất & Logistics công nghiệp:** Tổ hợp sản xuất Hải Phòng/Subang/Tamil Nadu, cánh tay robot lắp ráp khung gầm pin ván trượt, cảng container nước sâu Đình Vũ tấp nập tàu bốc dỡ hàng.
- **Biến động thị trường:** Bảng điện tử tài chính tại sàn giao dịch chứng khoán, màn hình giám sát trung tâm điều hành trạm sạc V-GREEN ngoài đời thực.

---

## ✍️ QUY CHUẨN ĐỊNH VỊ CHỮ TRÊN MÀN HÌNH (Selective Lower-Left 25% Rule)

*   **Tỷ lệ chọn lọc:** Chỉ xuất hiện ở 20% - 25% phân cảnh then chốt (số liệu đột phá, mốc thời gian, đạo luật, tỷ lệ tăng trưởng). 75% - 80% còn lại KHÔNG chèn chữ để giữ khung hình thoáng đãng.
...
*   **Ngôn ngữ hiển thị:** 
    *   Chuyển sang Tiếng Anh hoặc Tiếng Việt không dấu (ví dụ: `"REVENUE $10B"`, `"INTEREST RATE 4.5%"`, `"Q3 CAPITAL FLOW"`).
    *   Mô tả chữ: `compact subtle glowing amber 3D typography text overlay positioned fixedly in the lower-left area of the frame (elevated 25% above the bottom edge), facing camera directly, perfectly horizontal with crisp edges and heavy black drop shadow reading "[TEXT]"`.
*   **Khóa tĩnh chữ trong Video:** Khi cảnh có chữ, dòng `[VIDEO]` bắt buộc dùng cú máy tĩnh `Steady camera shot` để khóa chết vị trí chữ không bị méo lệch.
...
### Giải pháp Chuẩn Hóa của Kênh Dòng Chảy:
1.  **Chỉ đặt tên trên file tham chiếu:** Đặt tên nhân vật vào file ảnh tham chiếu (ví dụ `@ceo_vuong.jpg`, `@ceo_long.jpg`, `@lanhdao_xxx.jpg`).
...
| 06/09/2026 | Nâng cấp lên **Phiên bản 3.0: I2V Reference Asset Protocol**, tích hợp ảnh tham chiếu biểu tượng, công thức diện mạo trung tính (Zero-Bias Safety), bảng màu kem ngà sáng sủa `#FAF7EE`, slate `#2A323D` và chuẩn parser `flow_batch_studio`. |
