...
// Supported locales
export type SupportedLocale = 'fr' | 'en' | 'vi';

// Default locale
const DEFAULT_LOCALE: SupportedLocale = 'en'; // Changed default to 'en' or keep 'fr' if preferred, let's keep 'en' for safety if user prefers
