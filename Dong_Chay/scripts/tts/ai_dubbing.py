...
def try_gemini_translation(english_segments):
    ...
    try:
        ...
        prompt = f"""
        Bạn là biên dịch viên kịch bản tài chính - kinh tế của kênh Dòng Chảy.
...
def main():
    parser = argparse.ArgumentParser(description="Dòng Chảy Dubbing Pipeline CLI")
