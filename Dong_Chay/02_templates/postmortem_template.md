...
### 6.1. LLM Defect & Prompt Performance Audit (Tổng kết từ llm_error_log.md)

| Nhóm Phân Loại Lỗi | Số Lượng Ghi Nhận | Lỗi Nổi Bật Nhất / Tần Suất Cao Nhất |
|---|:---:|---|
| `[FORMAT_SYNTAX]` | | |
| `[VOCABULARY_TONE]` | | |
| `[DATA_GROUNDING]` | | |
...
- **Đánh giá hiệu suất LLM của tập:** [Rất tốt / Nhiều lỗi lặp lại / Cần can thiệp prompt sâu]
- **Đề xuất vá System Prompt / Rule / Skill rút ra:**
  1. 
  2. 
