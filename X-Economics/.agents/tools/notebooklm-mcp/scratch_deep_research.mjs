...
async function runResearch(query) {
  ...
  if (textarea) {
    ...
    await page.screenshot({ path: '/Users/pro16/Documents/VideoProject/GocNhinPodcast/scratch/deep_research_error.png' });
    await browser.close();
    return false;
  }
  ...
  await page.screenshot({ path: `/Users/pro16/Documents/VideoProject/GocNhinPodcast/scratch/deep_research_submitted_${Date.now()}.png` });
