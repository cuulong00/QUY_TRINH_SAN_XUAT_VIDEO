...
- **Hệ màu nhận diện:** Gam màu nền ngà kem ấm áp (`warm ivory cream ambient tone #FAF7EE`) mang chiều sâu báo chí quốc tế cao cấp, hoặc gam màu slate hiện đại (`#2A323D`, `#2C3539`, `#1E293B`). Điểm nhấn màu dữ liệu rực rỡ (`#F59E0B`, `#26A69A`, `#EF5350`).
