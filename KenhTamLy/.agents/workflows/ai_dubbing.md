...
> - Bắt buộc dùng môi trường Python của dự án: `/Users/pro16/Documents/VideoProject/KenhTamLy/venv/bin/python3`.
...
```bash
/Users/pro16/Documents/VideoProject/KenhTamLy/venv/bin/python3 -u scripts/tts/ai_dubbing.py \
  --slug "[slug]" \
