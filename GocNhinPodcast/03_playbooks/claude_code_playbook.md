...
Claude Code là lựa chọn mạnh nếu bạn muốn vận hành pipeline kịch bản phân tích xã hội & chính sách dài theo từng pha rõ ràng, với state files, slash commands, subagents, và hard review gates.
...
- "Use the editorial-qa subagent to review final_voiceover.md for episodes/chung-cu-vs-nha-dat"
