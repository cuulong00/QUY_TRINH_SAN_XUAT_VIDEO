...
description: Thumbnail design specialist. MUST BE USED when creating thumbnail prompts for YouTube videos. Proactively enforces HieuBietHon brand identity, typography hierarchy, and editorial design quality.
---
...
> `[Absolute Path: /Users/pro16/Documents/VideoProject/HieuBietHon/.agents/personas/the_visual_hook_director.md]`
>
...
- **Phiên bản 1 (Chuẩn Brand HieuBietHon mới):** Sử dụng thiết kế tiêu đề bằng các **màu nóng nổi bật** (đỏ, cam hoặc vàng rực), bố cục linh hoạt để tôn lên các chủ thể chính, viền chữ sắc nét theo `thumbnail_style_guide.md`.
...
3.  **Lưu file:** Cung cấp `save_path` tuyệt đối bên trong thư mục workspace (ví dụ: `/Users/pro16/Documents/VideoProject/HieuBietHon/episodes/[slug]/thumbnail_raw.png`).
