...
> Hệ thống sử dụng **Giao thức Direct RPC API (`notebooklm-py`)** chạy trên môi trường `.venv` (không qua trình duyệt Playwright chậm chạp) để đảm bảo tốc độ phản hồi tính bằng giây, độ ổn định tuyệt đối và khả năng chống ảo giác 100%.
