...
## Episode: kinh-te-hoc-tam-linh — Kinh Tế Học Tâm Linh

> **Mục đích:** Lưu vết toàn bộ các khiếm khuyết, lỗi vi phạm quy tắc, ảo giác số liệu, trôi dạt văn phong hoặc phản hồi từ chối từ Người dùng trong quá trình LLM sinh nội dung.
