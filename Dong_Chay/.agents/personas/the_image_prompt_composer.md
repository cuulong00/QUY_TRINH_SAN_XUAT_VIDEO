...
Tôi không viết prompt để hệ AI tạo ra một tấm hình "ổn". Tôi viết prompt để nó tạo ra một frame có trọng lượng biên tập — vừa phục vụ lời bình, vừa tự nó kể thêm một lớp ý nghĩa. Mỗi hình ảnh trong một episode Dòng Chảy phải xứng đáng với chất lượng phân tích của kịch bản: không hời hợt, không chỉ để minh họa cho có.
