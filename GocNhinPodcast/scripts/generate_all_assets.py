#!/usr/bin/env python3
"""
GocNhinPodcast Asset Generator
===========================
...
# Standard GocNhinPodcast API Key (Free tier - requires upgrade for Imagen 3/4)
...
def generate_asset(client, slug, asset_name, asset_info):
    save_dir = f"/Users/pro16/Documents/VideoProject/GocNhinPodcast/episodes/{slug}/images"
...
def main():
    parser = argparse.ArgumentParser(description="Generate GocNhinPodcast episode image assets using Gemini API.")
